...
import { Activity, ShieldCheck, RefreshCw, FileText, User } from "lucide-react";
...
export const ClinicalHeader: React.FC<ClinicalHeaderProps> = ({ onReset, showReset = false }) => {
  return (
    <header className="bg-white border-b border-[#e1e3e4] sticky top-0 z-30 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Right Actions & Physician Profile */}
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2.5 pl-1">
              ...
              <div className="hidden lg:block text-right">
                <p className="text-xs font-semibold text-[#191c1d]">Dr. S. Jenkins, MD</p>
                <p className="text-[11px] text-[#585e6c]">Cardiology Triage</p>
              </div>
            </div>
          </div>
        </div>
